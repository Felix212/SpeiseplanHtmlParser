// das ist für Bugfix in IE9 nötig
var isIE9Bugfix = false;
...
/*!
   ...
   Flowplayer Commercial v5.2.0 (Wednesday, 21. November 2012 04:34PM) | flowplayer.org/license
	 Diese Version macht Fehler in aktuelle FF, deswegen wurde durch neue v5.4.3 ersetzt.
*/

/*!

   Flowplayer v5.4.3 (Wednesday, 19. June 2013 11:34PM) | flowplayer.org/license
	 Original Flowplayer hat IE9 Bug (läst andere Video von Playliste nicht abspielen), diese Version wurde gefixt.
*/
!function($) { 
      ...
      load: function(video) {
         ...
         if (conf.splash && !api) {
            ...
            if (player.video.src && video.src != player.video.src) {
               ...
               // Bugfix IE9
               if (isIE9Bugfix) {
							 	 $('source', $(api))[0].src = video.src; // fix für IE9
							 } else {
								 api.src = video.src; // original code ist falsch, inkompatible mit W3C!
							 }
							 // end bugfix
...
//### IE9 Bugfix ###
flowplayer.engine.html5_1 = function(player, root) {
   ...
   return self = {
      ...
      load: function(video) {
         ...
         if (conf.splash && !api) {
            ...
            if (player.video.src && video.src != player.video.src) {
            	 // Bugfix IE9
							 //api.src = video.src; // ist falsch, inkompatible mit W3C!
							 $('source', $(api))[0].src = video.src;
							 // end bugfix
							 videoTag.attr("autoplay", "autoplay");
