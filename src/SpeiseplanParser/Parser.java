	...
	public POJO_Weekplan.Plan getWeekFood()
	{
		...
		for (int i = 1; i < 6; i++) {
			...
			for (int j = 1; j < rows.size(); j++) 
			{
				...
				//Wenn erste Zeile --> Feiertag �berspringen
				...
				else
				{
					...
					//Fallunterscheidung f�r Zeilen mit 5 tr Elementen und Zeilen 6 tr --> vorheriges aus i ausw�hlen wenn 5 tr Elementen
